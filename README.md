...
Um sistema de gerenciamento de vendas no formato CRUD em que é possível criar, visualizar, deletar e atualizar produtos e vendas. Foi utilizado o banco de dados MySQL para a gestão de dados, utilizando a arquitetura MSC (model-service-controller).
...
---
⌨️ desenvolvido por [Nicolas Hubner Santos](https://www.linkedin.com/in/nicolashubner/) 
